            ...
            <ion-list class="list">
                    ...
                    <ion-item-group v-if="newInspection.maintenance.selected">
                        <ion-item>
                            <ion-input 
                                label="Locatie:" 
                                :clear-input="true" 
                                v-model="newInspection.maintenance.location"
                            ></ion-input>
                        </ion-item>
                        ...
                        <ion-item lines="none">
                            <ion-select 
                                ...
                                v-model="newInspection.maintenance.type" 
                                placeholder="Selecteer" 
                                interface="action-sheet"
                            >
                        ...
                        <ion-item lines="none">
                            <ion-select 
                                ...
                                v-model="newInspection.maintenance.costIndication" 
                    ...
                    <ion-item-group v-if="newInspection.technicalInstallationInspection.selected">
                        <ion-item>
                            <ion-input 
                                label="Locatie:" 
                                :clear-input="true" 
                                v-model="newInspection.technicalInstallationInspection.location"
                            ></ion-input>
                        </ion-item>
                        ...
                        <ion-item lines="none">
                            <ion-select 
                                ...
                                v-model="newInspection.technicalInstallationInspection.installationType" 
                                placeholder="Selecteer" 
                                interface="action-sheet"
                                >
                        ...
                        <ion-item>
                            <ion-textarea 
                                ...
                                v-model="newInspection.technicalInstallationInspection.malfunctions"
                            ></ion-textarea>
                        </ion-item>
                ...
                <Transition>
                    <ion-item-group v-if="newInspection.inventorizeModifications.selected">
                        ...
                        <ion-item>
                            <ion-input 
                                label="Locatie modificatie:" 
                                :clear-input="true" 
                                v-model="newInspection.inventorizeModifications.location"
                            ></ion-input>
                        </ion-item>
                        ...
                        <ion-item lines="none">
                            <ion-select 
                                ...
                                placeholder="Selecteer" 
                                interface="action-sheet" 
                                v-model="newInspection.inventorizeModifications.executedBy"
                                >
                        ...
                        <ion-item>
                            <ion-input 
                                ...
                                :clear-input="true" 
                                v-model="newInspection.inventorizeModifications.description"
                            ></ion-input>
                        </ion-item>
